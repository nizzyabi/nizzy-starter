    ...
    <div id="pricing">
      ...
      <section>
        <div className="px-4 md:px-6 ">
          ...
          <div className="sm:grid sm:grid-cols-1 sm:place-items-center md:flex items-center justify-center gap-4 ">
            {tiers.map((tier) => (
              <div key={tier.name} className={`relative flex flex-col p-6 shadow-lg rounded-lg justify-between border bg-secondary w-full max-w-[550px]  ${tier.yourProduct ? 'border-violet-500' : 'border-primary/20 bg-secondary'}`}>
                {tier.yourProduct && (
